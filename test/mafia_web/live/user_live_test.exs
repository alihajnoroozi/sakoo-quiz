defmodule MafiaWeb.UserLiveTest do
  ...
  @create_attrs %{is_admin: "some is_admin", mobile: "some mobile", name: "some name", username: "some username"}
  ...
  describe "Index" do
    ...
    test "updates user in listing", %{conn: conn, user: user} do
      ...
      assert html =~ "some updated is_admin"
    end
